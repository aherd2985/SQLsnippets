...
--  take that subscription id and tell report servr to run it
EXEC [dbo].[AddEvent] 'TimedSubscription', 'Subscription ID';  -- @EventData;
...
where 
Convert(XML,[ExtensionSettings]).value('(//ParameterValue/Value[../Name="Subject"])[1]','nvarchar(50)') like '%Subject Namr%'